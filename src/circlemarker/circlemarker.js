...
let CircleMarkerElement = class CircleMarkerElement extends CoordinateHandler {
    ...
    ngOnInit() {
        ...
        if (this.LeafletElement || this.LeafletGroup) {
            ...
            let elementPosition = super.transformPointCoordinates(this.LeafletElement.crs);
